# WI869: FAM OS Sprint 1 — Foundation Build Brief

You are Tony Stark (software-engineer). Build the entire FAM OS Sprint 1 foundation: 35 new files + 1 FipShared change.

**Working directory: `/home/fredw/projects/fip/`**

## CRITICAL Non-Negotiable Rules

1. **DataProtection — BOTH lines MANDATORY:**
```csharp
builder.Services.AddDataProtection()
    .PersistKeysToDbContext<SharedKeyRingDbContext>()
    .SetApplicationName("FortressAI")          // MANDATORY — must match FAIT/FIRM/FORMS exactly
    .DisableAutomaticKeyGeneration();           // MANDATORY — prevents FAMOS from writing new keys
```

2. **`blazor.server.js` — NOT `blazor.web.js`** — FAMOS is Blazor Server only.

3. **FipModule.FAMOS = 4** in enum + all 3 extension methods.

4. **NO touches to FAIT, FIRM, or FORMS files** — only cross-app change is FipShared/Models/FipModule.cs.

5. **.NET 9** — `<TargetFramework>net9.0</TargetFramework>` and `mcr.microsoft.com/dotnet/aspnet:9.0`

6. **No EF migrations** — `CreateTablesAsync` pattern in Program.cs.

7. **No Kestrel block in appsettings** — do not add one.
...
```bash
mkdir -p ~/projects/fip/famos/src/FamOs.Web/Domain
mkdir -p ~/projects/fip/famos/src/FamOs.Web/Data/Entities
mkdir -p ~/projects/fip/famos/src/FamOs.Web/Services
mkdir -p ~/projects/fip/famos/src/FamOs.Web/Theme
mkdir -p ~/projects/fip/famos/src/FamOs.Web/Components/Layout
mkdir -p ~/projects/fip/famos/src/FamOs.Web/Components/Pages
mkdir -p ~/projects/fip/famos/src/FamOs.Web/wwwroot/css
```

---

## Step 2: `famos/src/FamOs.Web/FamOs.Web.csproj`
...
## Step 3: Modify `shared/FipShared/Models/FipModule.cs`

Add `FAMOS = 4` to the enum and three switch cases. The file currently has FAIT, FIRM, FORMS, Cowork. Add FAMOS = 4.
...
## Step 4: `famos/src/FamOs.Web/Domain/Enums.cs`
...
### `famos/src/FamOs.Web/Data/Entities/Opportunity.cs`
...
### `famos/src/FamOs.Web/Data/Entities/Submission.cs`
...
### `famos/src/FamOs.Web/Data/Entities/Quote.cs`
...
### `famos/src/FamOs.Web/Data/Entities/Proposal.cs`
...
### `famos/src/FamOs.Web/Data/Entities/PolicyShadowRecord.cs`
...
### `famos/src/FamOs.Web/Data/Entities/Activity.cs`
...
### `famos/src/FamOs.Web/Data/Entities/FamOsTask.cs`
...
### `famos/src/FamOs.Web/Data/Entities/OpportunityFlag.cs`
...
### `famos/src/FamOs.Web/Data/Entities/OutboxEvent.cs`
...
## Step 6: `famos/src/FamOs.Web/Data/FamOsDbContext.cs`
...
## Step 7: `famos/src/FamOs.Web/Domain/LifecycleCommandService.cs`
...
## Step 8: `famos/src/FamOs.Web/Domain/SignalResolver.cs`
...
## Step 9: `famos/src/FamOs.Web/Services/OutboxProcessorService.cs`
...
## Step 10: `famos/src/FamOs.Web/Services/SignalRecomputeService.cs`
...
## Step 11: `famos/src/FamOs.Web/Services/UserSessionService.cs`
...
## Step 12: `famos/src/FamOs.Web/Services/HubSpotServiceStub.cs`
...
## Step 13: `famos/src/FamOs.Web/Services/AmsServiceStub.cs`
...
## Step 14: `famos/src/FamOs.Web/Theme/FipTheme.cs`
...
/// This is the single source of truth for FIP design tokens in FAMOS.
...
## Step 15: `famos/src/FamOs.Web/Components/App.razor`
...
**IMPORTANT**: Uses `blazor.server.js` NOT `blazor.web.js`. This is a pure Blazor Server app.

---

## Step 16: `famos/src/FamOs.Web/Components/Routes.razor`
...
## Step 17: `famos/src/FamOs.Web/Components/Layout/MainLayout.razor`
...
## Step 18: `famos/src/FamOs.Web/Components/Layout/MainLayout.razor.css`
...
## Step 19: `famos/src/FamOs.Web/Components/Layout/NavMenu.razor`
...
## Step 21: `famos/src/FamOs.Web/wwwroot/css/famos.css`
...
## Step 22: `famos/src/FamOs.Web/appsettings.json`
...
## Step 23: `famos/src/FamOs.Web/appsettings.Development.json`
...
**NO Kestrel block. Do not add one.**

---

## Step 24: `famos/src/FamOs.Web/Program.cs`
...
## SUMMARY: Create all 35 files + modify FipModule.cs

Files to create:
1. famos/src/FamOs.Web/FamOs.Web.csproj
2. famos/src/FamOs.Web/Program.cs
3. famos/src/FamOs.Web/appsettings.json
4. famos/src/FamOs.Web/appsettings.Development.json
5. famos/src/FamOs.Web/Domain/Enums.cs
6. famos/src/FamOs.Web/Domain/LifecycleCommandService.cs
7. famos/src/FamOs.Web/Domain/SignalResolver.cs
8. famos/src/FamOs.Web/Data/FamOsDbContext.cs
9. famos/src/FamOs.Web/Data/Entities/Opportunity.cs
10. famos/src/FamOs.Web/Data/Entities/Submission.cs
11. famos/src/FamOs.Web/Data/Entities/Quote.cs
12. famos/src/FamOs.Web/Data/Entities/Proposal.cs
13. famos/src/FamOs.Web/Data/Entities/PolicyShadowRecord.cs
14. famos/src/FamOs.Web/Data/Entities/Activity.cs
15. famos/src/FamOs.Web/Data/Entities/FamOsTask.cs
16. famos/src/FamOs.Web/Data/Entities/OpportunityFlag.cs
17. famos/src/FamOs.Web/Data/Entities/OutboxEvent.cs
18. famos/src/FamOs.Web/Services/OutboxProcessorService.cs
19. famos/src/FamOs.Web/Services/SignalRecomputeService.cs
20. famos/src/FamOs.Web/Services/UserSessionService.cs
21. famos/src/FamOs.Web/Services/HubSpotServiceStub.cs
22. famos/src/FamOs.Web/Services/AmsServiceStub.cs
23. famos/src/FamOs.Web/Theme/FipTheme.cs
24. famos/src/FamOs.Web/Components/App.razor
25. famos/src/FamOs.Web/Components/Routes.razor
26. famos/src/FamOs.Web/Components/Layout/MainLayout.razor
27. famos/src/FamOs.Web/Components/Layout/MainLayout.razor.css
28. famos/src/FamOs.Web/Components/Layout/NavMenu.razor
29. famos/src/FamOs.Web/Components/Pages/Dashboard.razor
30. famos/src/FamOs.Web/Components/Pages/Pipeline.razor
31. famos/src/FamOs.Web/Components/Pages/TaskCenter.razor
32. famos/src/FamOs.Web/wwwroot/css/famos.css
33. famos/Dockerfile
34. famos/buildspec.yml

Modify (35th change):
35. shared/FipShared/Models/FipModule.cs — add FAMOS = 4 + 3 switch cases

All paths are relative to `/home/fredw/projects/fip/`.

Execute all steps above. Create every file exactly as specified. Do not skip any file. Do not modify any FAIT, FIRM, or FORMS files.
