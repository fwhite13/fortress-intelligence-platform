...
public class MicrosoftTokenService
{
    ...
    public MicrosoftTokenService(IDbContextFactory<AppDbContext> dbFactory, ILogger<MicrosoftTokenService> logger, IConfiguration configuration, IHttpClientFactory httpClientFactory)
    {
