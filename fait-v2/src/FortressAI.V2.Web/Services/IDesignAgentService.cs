...
public interface IDesignAgentService
{
    ...
    /// <summary>Save a generated artifact to S3 under workspaces/{userId}/artifacts/design/{sessionId}/. Returns the S3 key.</summary>
    Task<string> SaveArtifactAsync(string userId, string sessionId, string html, string artifactName, CancellationToken ct = default);
