...
exports.saveBrandContext = saveBrandContext;
exports.formatBrandContextForPrompt = formatBrandContextForPrompt;
...
async function getBrandContext(orgId) {
...
async function saveBrandContext(orgId, brand) {
    const key = `${BRAND_PREFIX}/${orgId}/brand.json`;
...
function formatBrandContextForPrompt(brand) {
    return `
...
function getFortressDefaults(orgId) {
    return {
        orgId,
        primaryColor: '#1a2332',
