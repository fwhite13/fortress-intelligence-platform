...
public static class QuoteComparisonSeed
{
    public static async Task SeedAsync(FamOsDbContext db)
    {
        ...
        var lines = new List<LineOfBusiness>
        {
            ...
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "mtc", Name = "Motor Truck Cargo", Icon = "📦", MetaDescription = "All-risk · refrigeration · loading/unloading", DisplayOrder = 3,
            ...
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "bt", Name = "Bobtail / Non-Trucking", Icon = "🔧", MetaDescription = "Bobtail · non-trucking liability · owner-operators", DisplayOrder = 4,
            ...
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "wc", Name = "Workers Comp", Icon = "🏥", MetaDescription = "Statutory · employer liability", DisplayOrder = 5,
            ...
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "oppacc", Name = "Occupational Accident", Icon = "🦺", MetaDescription = "Occupational accident · owner-operators", DisplayOrder = 6, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "umb", Name = "Umbrella / Excess", Icon = "☂️", MetaDescription = "Follows form · excess over GL, auto, cargo", DisplayOrder = 7,
            ...
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "pol", Name = "Pollution Liability", Icon = "☣️", MetaDescription = "Pollution liability", DisplayOrder = 8, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "pl", Name = "Professional Liability", Icon = "📋", MetaDescription = "Professional liability / E&O", DisplayOrder = 9, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "do", Name = "Directors & Officers", Icon = "👔", MetaDescription = "Directors & Officers liability", DisplayOrder = 10, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "prop", Name = "Commercial Property", Icon = "🏢", MetaDescription = "Commercial property · building & contents", DisplayOrder = 11, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "cyb", Name = "Cyber Liability", Icon = "🔐", MetaDescription = "Cyber liability · data breach", DisplayOrder = 12, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "ti", Name = "Trade Insurance", Icon = "🤝", MetaDescription = "Trade insurance", DisplayOrder = 13, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "cr", Name = "Crime", Icon = "🔒", MetaDescription = "Crime / fidelity", DisplayOrder = 14, FieldDefinitions = "[]" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "other", Name = "Other", Icon = "📎", MetaDescription = "Other coverage", DisplayOrder = 15, FieldDefinitions = "[]" }
        };
        ...
        var requirements = new List<Requirement>
        {
            ...
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "rq-ca-all", Label = "⚠ Pending TIG ops review: Cargo — All Risk ($250K min)", GroupName = "Motor Truck Cargo", LineOfBusinessId = lineBySlug["mtc"], DisplayOrder = 7 },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "rq-ca-ref", Label = "⚠ Pending TIG ops review: Refrigeration Breakdown", GroupName = "Motor Truck Cargo", LineOfBusinessId = lineBySlug["mtc"], DisplayOrder = 8 },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, TenantId = tenantId, Slug = "rq-pd-sv", Label = "⚠ Pending TIG ops review: Bobtail / Non-Trucking — Stated Value", GroupName = "Bobtail / Non-Trucking", LineOfBusinessId = lineBySlug["bt"], DisplayOrder = 9 },
        ...
        var benchmarks = new List<BenchmarkPremium>
        {
            ...
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, LineOfBusinessId = lineBySlug["mtc"], TenantId = tenantId, AnnualPremium = 30000, EffectiveDate = DateOnly.FromDateTime(DateTime.UtcNow), Source = "manual" },
            new() { Id = Guid.NewGuid(), ProgramVerticalId = verticalId, LineOfBusinessId = lineBySlug["bt"], TenantId = tenantId, AnnualPremium = 19500, EffectiveDate = DateOnly.FromDateTime(DateTime.UtcNow), Source = "manual" },
        ...
        {
            new() { Id = Guid.NewGuid(), TenantId = tenantId, CarrierName = "Markel", PrimaryLineSlug = "gl", RequiredLineSlug = "mtc", IsActive = true, Notes = "Markel bundles mtc with GL" },
            new() { Id = Guid.NewGuid(), TenantId = tenantId, CarrierName = "Philadelphia", PrimaryLineSlug = "auto", RequiredLineSlug = "bt", IsActive = true, Notes = "Philadelphia bundles bt with Auto" },
            new() { Id = Guid.NewGuid(), TenantId = tenantId, CarrierName = "Progressive", PrimaryLineSlug = "auto", RequiredLineSlug = "bt", IsActive = true, Notes = "Progressive bundles bt with Auto" }
        };
